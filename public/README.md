...
|------|----------|-----------|---------|
| `treeland-capture-snap-unstable-v1.xml` | `treeland_capture_snap_unstable_v1` | `treeland_capture_snap_v1` | Compositor-side snap region hints for screenshot/recording preview |
